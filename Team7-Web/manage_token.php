<?php
    ...
    function encode_jwt($id, $userid) {   //กำหนด key สำหรับ encode jwt
        $key = "JWT_Ced_Team7";
    ...
    function decode_jwt($jwt) {
        ...
        try{
            ...
            $payload = JWT::decode($jwt, $key, ['algorithm' => 'HS256']);
    ...
    // if($action == "get_token")
    // {
    //     $userid = $_SESSION['userid'];//รับข้อมูล User จาก client
    //     echo encode_jwt($userid);//ส่ง token ไปให้ client
    // }
